...
export var SubsetVis = function SubsetVis(_ref) {
  ...
  var refContainer = useRef("Container");
  var refUnit = useRef("UnitVis");
  var refIcicle = useRef("IcicleVis");
  // const refTooltip = useRef("Tooltip");
  var refStats = useRef("Stats");
  var refShow = useRef("Show");
  var refFilter = useRef("Filters");
  var refSubset = useRef("SubsetContainer");
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    ref: refFilter
  }, /*#__PURE__*/React.createElement(SubsetFilter, {
    data: data,
